# INTENTIONALLY MALFORMED - This file tests parser error handling.
# Known issues:
#   - Line 2: inline comment after tags (currently rejected)
#   - Line 5: "And" keyword in description (invalid per Gherkin spec)
#   - Line 9+: Rule block not parsed because earlier errors break context
# The tokenizer roundtrip still works; only parsing fails.
